...
(function($) {
    $.fn.ttwMusicPlayer = function(playlist, userOptions) {
        ...
        appMgr = function() {
            ...
            //不初始化评级到播放列表已经建成,之后也不会等到jPlayer事件做好准备
        ...
        playlistMgr = function() {
            ...
            function init(playlistOptions) {
                ...
                $myJplayer.bind($.jPlayer.event.ready, function() {
                    ...
                    //绑定jPlayer事件。并不想在选择对象,以阻止他们被用户覆盖吗
            ...
            function buildPlaylist() {
                ...
                if (remainingHeight > 0) {
                    ...
                    $trackList.find('.upmore').click(function() {
                        $tracksWrapper.animate({height:showHeight}, function() {                      		
                    		$('.upmore').hide();
                    		$more.show();
                		});
                    });
        ...
        interfaceMgr = function() {
            ...
            function buildInterface() {
                ...
                markup = '<div class="ttw-music-player">' +
                        ...
                        '            <p class="title"></p>' +
                        '            <p class="artist-outer">歌手<span class="artist"></span></p>' +
                        '            <div class="rating">' +
